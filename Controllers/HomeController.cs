...
using AspNetAndWebDevelopment_Task3.Models;
using Microsoft.AspNetCore.Mvc;

namespace AspNetAndWebDevelopment_Task3.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult GetInfo(string a1, string a2, string a3, string b1, string b2, string b3, string c1,
            string c2, string c3)
        {
            List<string> list = new() { a1, a2, a3, b1, b2, b3, c1, c2, c3 };
            ...
            {
                int compare1 = string.CompareOrdinal(e[0], e[1]);
                int compare2 = string.CompareOrdinal(e[1], e[2]);
                int compare3 = string.CompareOrdinal(e[0], e[2]);
                if (compare1 == 0
                    && compare2 == 0
                    && compare3 == 0
